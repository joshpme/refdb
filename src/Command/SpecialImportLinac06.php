 ...
 * @package App\Command
 */
class SpecialImportLinac06 extends Command
{
    private EntityManagerInterface $manager;

    // the name of the command (the part after "bin/console")
    protected static $defaultName = 'app:special-import-linac-06';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $data = file("src/DataFixtures/Import/linac06.txt");
        ...
        $conference = $this->manager->getRepository(Conference::class)->findOneBy(['code' => 'LINAC\'06']);
